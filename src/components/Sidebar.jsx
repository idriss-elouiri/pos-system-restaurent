...
export default function Sidebar({show}) {
  ...
  return (
    <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-gray-300 h-screen md:static md:w-[300px] transition-all"}>
      ...
      <nav className="flex flex-col gap-2">
        ...
        <Link href={'/hrm'} className={pathname === ('/hrm') ? activeLink : inactiveLink}>
          <span className={pathname === '/hrm' ? activeIcon : inactiveIcon}><FaUser/></span>
          HRM
        </Link>
        <Link href={'/customers'} className={pathname === ('/customers') ? activeLink : inactiveLink}>
