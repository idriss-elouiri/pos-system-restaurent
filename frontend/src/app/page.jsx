...
export default function Home() {
  ...
  <ul className="flex justify-center items-center gap-20 text-xl mt-5">
    ...
    <li className="py-5 px-5 bg-slate-300 text-slate-600 rounded-xl"><Link href="/staffLogin">Cashier Login</Link></li>
    <li className="py-5 px-5 bg-slate-300 text-slate-600 rounded-xl"><Link href="/customerLogin">Custumer Login</Link></li>
  </ul>
  </div>
  );
}
