...
export default function ProfileCustomer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${apiUrl}/api/customer/updateCustomer/${currentUser._id}`, {
        method: "PUT",
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`${apiUrl}/api/customer/deleteCustomer/${currentUser._id}`, {
        method: "DELETE",
      });
      const data = await res.json();
      if (!res.ok) {
  ...
  const handleSignout = async () => {
    try {
      const res = await fetch(`${apiUrl}/api/customer/signoutCustomer`, { method: "POST" });
      const data = await res.json();
      if (!res.ok) {
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <input
          ...
          id="nameCustomer"
          placeholder="Name"
          defaultValue={currentUser.nameCustomer}
        ...
        <input
          ...
          id="emailCustomer"
          placeholder="Email"
          defaultValue={currentUser.emailCustomer}
          onChange={handleChange}
          className="p-3 border rounded-md"
        />
        <input
